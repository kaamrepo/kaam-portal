      ...
      <div className=" h-full flex flex-wrap items-center">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <h2 className="text-center mb-9 text-2xl font-bold text-black dark:text-whitex sm:text-title-xl2">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-row items-center">
                  ...
                  <button
                    ...
                    className={`h-12 ml-2 bg-primaryBGColor text-white px-3 py-2 rounded-lg ${
                      isSendingOTP ||
                      phoneNumber.length !== 10 ||
                      otp.length >= 4
              ...
              <div className="mb-6">
                ...
                <div className="">
                  <input
                    ...
                    className={`h-12 w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${
